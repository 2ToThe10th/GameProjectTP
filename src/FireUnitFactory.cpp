...
FireUnitFactory::FireUnitFactory(Player which, Map& map, Money& money) : UnitFactory(which, map, money, Race::Fire) {}

void FireUnitFactory::AddWarrior(City &where) {
...
void FireUnitFactory::AddArcher(City &where) {
    if(map.combat(where.location) != nullptr) {
        cout << "Other combat unit is already there" << endl;
        cout << map.combat(where.location)->Info() << endl;
        return;
...
void FireUnitFactory::AddWizard(City &where) {
    if(map.combat(where.location) != nullptr) {
        cout << "Other combat unit is already there" << endl;
        cout << map.combat(where.location)->Info() << endl;
        return;
