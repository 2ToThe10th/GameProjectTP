...
WaterUnitFactory::WaterUnitFactory(Player which, Map& map, Money& money) : UnitFactory(which, map, money, Race::Water) {}

void WaterUnitFactory::AddWarrior(City &where) {
...
void WaterUnitFactory::AddArcher(City &where) {
    if(map.combat(where.location) != nullptr) {
        cout << "Other combat unit is already there" << endl;
        cout << map.combat(where.location)->Info() << endl;
        return;
...
void WaterUnitFactory::AddWizard(City &where) {
    if(map.combat(where.location) != nullptr) {
        cout << "Other combat unit is already there" << endl;
        cout << map.combat(where.location)->Info() << endl;
        return;
