...
EarthUnitFactory::EarthUnitFactory(Player which, Map& map, Money& money) : UnitFactory(which, map, money, Race::Earth) {}

void EarthUnitFactory::AddWarrior(City &where) {
...
void EarthUnitFactory::AddArcher(City &where) {
    if(map.combat(where.location) != nullptr) {
        cout << "Other combat unit is already there" << endl;
        cout << map.combat(where.location)->Info() << endl;
        return;
...
void EarthUnitFactory::AddWizard(City &where) {
    if(map.combat(where.location) != nullptr) {
        cout << "Other combat unit is already there" << endl;
        cout << map.combat(where.location)->Info() << endl;
        return;
