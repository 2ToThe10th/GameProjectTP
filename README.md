...
|**Wizard Town**| 300 | 300 | 100 |
    ...
    #TODO:
    Обьекты строятся за несколько ходов
...
нет другого военного юнита (идея: Civilization)
    ...
    #TODO:
    Команды:
    * Создать город на месте где стоит колонист 
...
* Если военный юнит атакует мирного юнита другого игрока, то мирный юнит умирает