...
|**Wizard Town**| 300 | 300 | 100 |
    ...
    #TODO:
    Обьекты создаются не сразу а через несколько ходов
...
нет другого военного юнита (идея: Civilization)
    ...
    # TODO:
    Пока реализована только первый ход для проверки создания юнитов,
    позже будет реализована передача информации между пользователями и 
    второй пользователь тоже сможет играть

    #TODO:
    Команды:
    * Создать город
    * Создать юнита в городе
    * Построить башню в городе
    * Конец хода
    * Перейти на соседнюю клетку юнитом (всеми кроме колониста)
    * Аттака юнитом
